      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="bg-[#ec3137] text-white px-4 py-2 rounded-lg">
            ...
            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-400 rounded-lg focus:ring-2 focus:ring-[#ec3137] focus:border-[#ec3137] dark:bg-[#322020] dark:text-white disabled:opacity-50"
            >
            ...
            <div key={product.id} className="bg-white dark:bg-[#2a2a2a] dark:bg-[#322020] rounded-lg shadow-sm border border-gray-200 dark:border-gray-400 overflow-hidden hover:shadow-md transition-shadow">
            {/* Product Image */}
            <div className="relative h-48 bg-gray-200 dark:bg-[#322020]">
            {product.image ? (
            <img
            src={product.image}
            alt={product.name}
