    ...
    <div className="bg-gradient-to-br from-green-50 via-white to-blue-50 dark:from-gray-900 dark:via-[#0a0a0a] dark:to-gray-900 min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-4 lg:px-8 xl:px-12 py-12">
        ...
        <div className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 rounded-xl p-6 mb-8 shadow-lg animate-slideUp" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center p-3 bg-gray-50 dark:bg-[#0f0f0f] rounded-lg">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">{t('orderSuccess.total')}</p>
            ...
            <div className="text-center p-3 bg-gray-50 dark:bg-[#0f0f0f] rounded-lg">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">{t('orderSuccess.delivery')}</p>
            ...
            <div className="text-center p-3 bg-gray-50 dark:bg-[#0f0f0f] rounded-lg">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">{t('orderSuccess.email')}</p>
              ...
              <>
                ...
                <div className="flex items-center gap-4 bg-white dark:bg-[#0a0a0a] border border-amber-200 dark:border-amber-900 rounded-lg p-3">
                  ...
                  {giftProduct.thumbnail?.fullUrl ? (
                    ...
                    <div className="w-20 h-20 sm:w-24 sm:h-24 flex-shrink-0 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 rounded-xl p-5 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">{t('orderSuccess.trackOrderDesc')}</p>
          ...
          <div className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 rounded-xl p-5 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">{t('orderSuccess.continueShoppingDesc')}</p>
          ...
          <div className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 rounded-xl p-5 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">{t('orderSuccess.needHelpDesc')}</p>
