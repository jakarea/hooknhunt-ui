...
function ProductDetailPageContent() {
  ...
  const [activeTab, setActiveTab] = useState<'description' | 'attributes' | 'keyfeatures' | 'reviews'>('description');
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {(localizedHighlights && localizedHighlights.length > 0) ? (
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-200">No features available.</p>
                    )}
                  </div>
                </div>
              )}
