...
export default function ProductReviews({ productSlug, productId }: ProductReviewsProps) {
  ...
  if (filteredReviews.length === 0 && !productLoading) {
    return (
      <div className="bg-white dark:bg-[#0a0a0a] p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-sm text-center">
        {/* Empty State Icon */}
  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-sm">
      ...
      <div className="mb-6 flex flex-wrap items-center gap-2">
        <span className="text-body-sm font-semibold text-gray-700 dark:text-gray-300 mr-2">
          Filter by rating:
        </span>
            ...
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border-2 transition-all ${
                isSelected
                  ...
                  : 'border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-[#ec3137] dark:hover:border-[#ec3137]'
              }`}
            >
      ...
      {productLoading && (
        <div className="flex justify-center py-8">
          <div className="inline-flex items-center gap-2">
            ...
            <span className="text-body-sm text-gray-600 dark:text-gray-400">Loading more reviews...</span>
          </div>
        </div>
      )}
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-gray-100 dark:bg-gray-900">
        ...
        {/* Rating Badge */}
        <div className="absolute top-2 right-2 flex items-center gap-1 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm px-2 py-1 rounded-full shadow-md">
