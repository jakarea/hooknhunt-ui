...
function ProductReviewCard({ review }: ProductReviewCardProps) {
  ...
  return (
    <div
      className="break-inside-avoid mb-4 group relative bg-white dark:bg-[#1a1a1a] rounded-none overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer"
      onClick={() => setIsExpanded(!isExpanded)}
    >
      {/* Screenshot */}
      <div className="relative aspect-[3/4] overflow-hidden bg-gray-100 dark:bg-[#1a1a1a]">
        <Image
          src={screenshotUrl}
        ...
        {/* Rating Badge */}
        <div className="absolute top-2 right-2 flex items-center gap-1 bg-white/95 dark:bg-[#1a1a1a]/95 backdrop-blur-sm px-2 py-1 rounded-full shadow-md">
