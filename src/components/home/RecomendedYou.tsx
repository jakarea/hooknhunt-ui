        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-heading-xl md:text-heading-2xl font-bold text-gray-900 dark:text-white">{t('home.recommended.title')}</h3>
            </div>
            <p className="text-body-lg text-gray-600 dark:text-gray-400 ml-4">{t('home.recommended.subtitle')}</p>
          </div>
