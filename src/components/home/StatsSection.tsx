    ...
    <section id="stats-section" className="py-16 lg:py-24 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#0f0f0f] dark:to-[#1a1a1a] relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-6 px-8 py-4 bg-white dark:bg-[#2a2a2a] dark:bg-[#322020] rounded-lg shadow-lg border border-gray-200 dark:border-gray-400">
