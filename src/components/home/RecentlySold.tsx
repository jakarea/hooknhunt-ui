    ...
    <section className="bg-[#fee1e1] dark:bg-[#0f0f0f] py-10 transition-colors duration-200">
      <div className="container">
        ...
        <div className="text-center mt-5 md:mt-6">
          <Link href="/products?sort=recent-sold" className="inline-flex items-center gap-2 px-4 py-2 bg-[#ec3137] hover:bg-[#c5282d] text-white font-medium rounded-lg transition-all duration-300 hover:shadow-md text-sm">
            <span>{t('home.recentlySold.viewAll')}</span>
