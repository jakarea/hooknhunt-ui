...
export default function Header() {
  ...
  return (
    <header className="bg-white dark:bg-[#0a0a0a] z-50">
            ...
            <div className="hidden md:flex flex-1 max-w-md" ref={searchRef}>
              <div className="relative w-full">
                <form onSubmit={handleSearch}>
                  <div className="relative flex items-center">
                    <input
                      ...
                      className="w-full h-9 sm:h-10 pl-10 pr-4 text-sm border-2 border-gray-200 dark:border-gray-700 rounded-full focus:outline-none focus:border-[#bc1215] focus:ring-2 focus:ring-[#bc1215]/10 transition-all bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 placeholder-gray-400"
                    />
                    <svg className="absolute left-3.5 sm:left-4 w-3.5 sm:w-4 h-3.5 sm:h-4 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {showSuggestions && searchQuery.trim().length >= 2 && (
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-50 max-h-96 overflow-y-auto">
                    {isSearching ? (
                    ...
                    {searchSuggestions.length > 0 && (
                      <div className="p-2 border-t border-gray-100 dark:border-gray-800">
                        <button
                          ...
                          className="w-full text-center text-sm text-[#bc1215] hover:text-[#8a0e10] font-medium py-2 transition-colors"
                        >
      ...
      <div className={`hidden lg:block bg-[#bc1215] dark:bg-[#0a0a0a] transition-all py-1 duration-300 ${isNavSticky ? 'sticky top-0 z-40 shadow-md' : ''}`}>
        <div className="container">
              ...
              <form onSubmit={handleSearch}>
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full h-9 pl-11 pr-4 text-sm border border-gray-300 dark:border-gray-700 rounded-full focus:outline-none focus:border-[#bc1215] focus:ring-2 focus:ring-[#bc1215]/20 transition-all bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 placeholder-gray-400"
                  />
                  <svg className="absolute left-4 w-4 h-4 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                </div>
              </form>
            ...
            <nav className="flex flex-col space-y-1">
              {navItems.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="px-3 py-2 text-sm md:text-base font-medium text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-[#1a1a1a] hover:text-[#bc1215] transition-colors flex items-center gap-2 rounded-lg"
