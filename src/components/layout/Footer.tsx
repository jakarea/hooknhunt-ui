        ...
        <div className="max-w-[1192px] mx-auto px-3 md:px-4 py-4 md:py-6" suppressHydrationWarning>
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4" suppressHydrationWarning>
            ...
            <div className="flex items-center gap-2 md:gap-4 flex-wrap justify-center">
              <span className="text-xs md:text-sm lg:text-[17px] text-white/70">{t('footer.weAccept')}</span>
              <div className="flex gap-1.5 md:gap-2">
                <div className="bg-white px-2 md:px-3 py-1 md:py-1.5 rounded-lg">
                  <span className="text-[#1434CB] font-bold text-xs md:text-sm">VISA</span>
                </div>
                <div className="bg-white px-2 md:px-3 py-1 md:py-1.5 rounded-lg">
                  <span className="text-[#EB001B] font-bold text-xs md:text-sm">MASTER</span>
                </div>
                <div className="bg-white px-2 md:px-3 py-1 md:py-1.5 rounded-lg">
                  <span className="text-[#016FD0] font-bold text-xs md:text-sm">AMEX</span>
                </div>
              </div>
            </div>
          </div>
