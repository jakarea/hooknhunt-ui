        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-2 gap-y-6 md:gap-x-8 md:gap-y-8 lg:gap-x-12 lg:gap-y-12" suppressHydrationWarning>
          ...
          <div className="col-span-2 md:col-span-1" suppressHydrationWarning>
            ...
            <div className="flex items-center gap-2 md:gap-3 mt-4 md:mt-6" suppressHydrationWarning>
              {/* TODO: Update with your actual Facebook page URL */}
              <a
                href="https://www.facebook.com"
                title="Follow us on Facebook"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 md:w-10 md:h-10 bg-white dark:bg-[#2a2a2a]/10 rounded-full flex items-center justify-center hover:bg-[#ec3137] transition-colors group flex-shrink-0"
              >
              ...
              {/* TODO: Update with your actual YouTube channel URL */}
              <a
              ...
              {/* TODO: Update with your actual Instagram profile URL */}
              <a
          ...
          <div suppressHydrationWarning>
            ...
            {loading ? (
              <div className="space-y-2 md:space-y-3">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="h-5 bg-white dark:bg-[#2a2a2a]/10 rounded animate-pulse"></div>
                ))}
              </div>
            ) : (
              <ul className="space-y-2 md:space-y-3">
                {categories.map((category) => (
                  <li key={category.id}>
                    ...
                    >
                      <span className="w-1 h-1 md:w-1.5 md:h-1.5 bg-white/30 rounded-full mr-1.5 md:mr-2 group-hover:bg-white dark:bg-[#2a2a2a] transition-colors flex-shrink-0"></span>
          ...
          <div className="col-span-2 md:col-span-1" suppressHydrationWarning>
            ...
            <ul className="space-y-3 md:space-y-4">
              <li className="flex items-start">
                <div className="w-8 h-8 md:w-10 md:h-10 bg-white dark:bg-[#2a2a2a]/10 rounded-full flex items-center justify-center flex-shrink-0 mr-2 md:mr-3">
