...
export default function CartDeliveryEstimate({ onCalculated }: CartDeliveryEstimateProps) {
  ...
  if (calculating) {
    return (
      <div className="flex items-center justify-between py-2">
        <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Delivery estimate</span>
      ...
      return (
        <div className="space-y-2">
          ...
          <div className={`relative ${highlightColor === 'green' ? 'bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 border-green-300 dark:border-green-700' : 'bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/30 dark:to-amber-900/30 border-orange-300 dark:border-orange-700'} border rounded-xl p-4 shadow-sm`}>
            ...
            <div className="flex items-center gap-3 pr-6">
              ...
              <div className="flex-1">
                <p className={`text-base font-bold ${highlightColor === 'green' ? 'text-green-800 dark:text-green-200' : 'text-orange-800 dark:text-orange-200'} leading-snug`}>
          ...
          <div className="flex items-center justify-between py-1.5">
            <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Delivery</span>
  ...
  return (
    <div className="flex items-center justify-between py-2">
      <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Delivery (Inside Dhaka)</span>
