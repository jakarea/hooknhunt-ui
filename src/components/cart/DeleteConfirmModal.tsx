  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[201] flex items-center justify-center p-4">
        <div className="bg-white dark:bg-[#0a0a0a] border-2 border-gray-200 dark:border-gray-500 rounded-2xl shadow-2xl max-w-md w-full animate-scaleIn">
          {/* Header with Warning Icon */}
          <div className="p-6 border-b border-gray-200 dark:border-gray-500">
          ...
          {/* Action Buttons */}
          <div className="p-6 bg-gray-50 dark:bg-[#0f0f0f] border-t border-gray-200 dark:border-gray-500 flex gap-3">
            <button
              onClick={onCancel}
            ...
            <button
              onClick={onConfirm}
              className="py-3 px-4 bg-gray-200 dark:bg-gray-700 hover:bg-red-600 hover:text-white dark:hover:bg-red-600 text-gray-700 dark:text-gray-100 font-semibold rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
