...
const resources = {
  en: {
    translation: {
      ...
      'cart.page.calculatedAtCheckout': 'Calculated at checkout →',
      ...
      'orderSuccess.accountSetup.title': 'Create Your Account',
      'orderSuccess.accountSetup.description': 'We have created an account for you! Set a password to:',
      'orderSuccess.accountSetup.benefit1': 'Track this order easily',
      'orderSuccess.accountSetup.benefit2': 'View order history',
      'orderSuccess.accountSetup.benefit3': 'Save addresses for faster checkout',
      'orderSuccess.accountSetup.benefit4': 'Get exclusive offers',
      'orderSuccess.accountSetup.passwordPlaceholder': 'Enter password (min 6 characters)',
      'orderSuccess.accountSetup.confirmPlaceholder': 'Confirm password',
      'orderSuccess.accountSetup.createButton': 'Create Account',
      'orderSuccess.accountSetup.creating': 'Creating...',
      'orderSuccess.accountSetup.skipButton': 'Skip',
      'orderSuccess.accountSetup.success': 'Account Created Successfully!',
      'orderSuccess.accountSetup.successDescription': 'You can now login with your phone number and password to track orders.',
      'orderSuccess.accountSetup.passwordMismatch': 'Passwords do not match',
      'orderSuccess.accountSetup.passwordTooShort': 'Password must be at least 6 characters',
      ...
      'auth.register.phoneFormat': 'Format: 01xxxxxxxxx (11 digits)',
      ...
      'auth.validation.phoneInvalid': 'Please enter a valid Bangladeshi number (01xxxxxxxxx)',
      'auth.validation.termsRequired': 'You must agree to terms and conditions',
      'auth.api.phoneExists': 'This number is already registered. Sign in instead.',
      'auth.api.emailExists': 'This email is already registered.',
      'auth.api.invalidCredentials': 'Invalid credentials.',
      'auth.api.userNotFound': 'User not found.',
      'auth.api.generalError': 'Something went wrong. Please try again.',
  ...
  bn: {
    translation: {
      ...
      'cart.page.calculatedAtCheckout': 'চেকআউটে হিসাব করা হবে →',
      ...
      'orderSuccess.accountSetup.title': 'আপনার অ্যাকাউন্ট তৈরি করুন',
      'orderSuccess.accountSetup.description': 'আমরা আপনার জন্য একটি অ্যাকাউন্ট তৈরি করেছি! পাসওয়ার্ড সেট করুন:',
      'orderSuccess.accountSetup.benefit1': 'এই অর্ডারটি সহজে ট্র্যাক করুন',
      'orderSuccess.accountSetup.benefit2': 'অর্ডার ইতিহাস দেখুন',
      'orderSuccess.accountSetup.benefit3': 'দ্রুত চেকআউটের জন্য ঠিকানা সংরক্ষণ করুন',
      'orderSuccess.accountSetup.benefit4': 'এক্সক্লুসিভ অফার পান',
      'orderSuccess.accountSetup.passwordPlaceholder': 'পাসওয়ার্ড লিখুন (মিনিমাম ৬ অক্ষর)',
      'orderSuccess.accountSetup.confirmPlaceholder': 'পাসওয়ার্ড নিশ্চিত করুন',
      'orderSuccess.accountSetup.createButton': 'অ্যাকাউন্ট তৈরি করুন',
      'orderSuccess.accountSetup.creating': 'তৈরি হচ্ছে...',
      'orderSuccess.accountSetup.skipButton': 'এড়িয়ে যান',
      'orderSuccess.accountSetup.success': 'অ্যাকাউন্ট সফলভাবে তৈরি হয়েছে!',
      'orderSuccess.accountSetup.successDescription': 'এখন আপনি আপনার ফোন নম্বর এবং পাসওয়ার্ড দিয়ে লগইন করতে পারবেন অর্ডার ট্র্যাক করতে।',
      'orderSuccess.accountSetup.passwordMismatch': 'পাসওয়ার্ড মিলছে না',
      'orderSuccess.accountSetup.passwordTooShort': 'পাসওয়ার্ড অন্তত ৬ অক্ষর হতে হবে',
      ...
      'auth.register.email': 'ইমেইল',
      'auth.register.phone': 'ফোন নম্বর',
      'auth.register.password': 'পাসওয়ার্ড',
      'auth.register.confirmPassword': 'পাসওয়ার্ড আবার লিখুন',
      ...
      'auth.register.button': 'অ্যাকাউন্ট খুলুন',
      'auth.register.haveAccount': 'আগেই অ্যাকাউন্ট আছে?',
      'auth.register.login': 'লগইন করুন',
      'auth.register.failed': 'নিবন্ধন হয়নি। আবার চেষ্টা করুন।',
      'auth.register.changePhone': 'নম্বর বদলান',
      'auth.register.phoneHint': 'বাংলাদেশের ফোন নম্বর দিন',
      'auth.register.phoneFormat': 'ফরম্যাট: 01xxxxxxxxx (১১ ডিজিট)',
      'auth.register.passwordPlaceholder': 'পাসওয়ার্ড দিন',
      'auth.register.confirmPasswordPlaceholder': 'পাসওয়ার্ড আবার দিন',
      ...
      'auth.validation.emailRequired': 'ইমেইল দিন',
      'auth.validation.emailInvalid': 'সঠিক ইমেইল ঠিকানা দিন',
      'auth.validation.passwordRequired': 'পাসওয়ার্ড দিন',
      'auth.validation.passwordMin': 'পাসওয়ার্ড কমপক্ষে ৬ অক্ষরের হতে হবে',
      'auth.validation.passwordMatch': 'পাসওয়ার্ড মেলেনি',
      'auth.validation.nameRequired': 'নাম দিন',
      'auth.validation.phoneRequired': 'ফোন নম্বর দিন',
      'auth.validation.phoneInvalid': 'সঠিক বাংলাদেশের নম্বর দিন (01xxxxxxxxx)',
      'auth.validation.termsRequired': 'শর্তাবলীতে সম্মত হতে হবে',
      'auth.api.phoneExists': 'এই নম্বর দিয়ে ইতিমধ্যেই অ্যাকাউন্ট খোলা হয়ে গেছে। অনুগ্রহ করে লগইন করুন।',
      'auth.api.emailExists': 'এই ইমেইল দিয়ে ইতিমধ্যেই অ্যাকাউন্ট খোলা হয়ে গেছে।',
      'auth.api.invalidCredentials': 'ফোন নম্বর বা পাসওয়ার্ড ভুল হয়েছে।',
      'auth.api.userNotFound': 'এই নম্বর দিয়ে কোনো অ্যাকাউন্ট পাওয়া যায়নি।',
      'auth.api.generalError': 'কিছু একটা সমস্যা হয়েছে। আবার চেষ্টা করুন।',
