...
function ProductDetailPage() {
    ...
    const handleImageChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductDetailPage.useCallback[handleImageChange]": (index)=>{
            if (index === selectedImage) return;
            setSelectedImage(index);
        }
    }["ProductDetailPage.useCallback[handleImageChange]"], [
        selectedImage
    ]);
    ...
    const getVariantGroup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductDetailPage.useCallback[getVariantGroup]": (variantName)=>{
            if ([
                'Small',
                'Medium',
                'Large',
    ...
    }["ProductDetailPage.useCallback[getVariantGroup]"], []);
    // Group variants by type using useMemo for performance
    const groupedVariants = useMemo({
        "ProductDetailPage.useMemo[groupedVariants]": ()=>{
            if (!product.variants || product.variants.length === 0) {
                return {};
            }
            const groups = {};
            product.variants.forEach({
                "ProductDetailPage.useMemo[groupedVariants]": (variant)=>{
                            ...
                            categories: staticProduct.category_id ? [
                                {
                                    ...
                                    slug: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$static$2d$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["staticCategories"].find({
                                        "ProductDetailPage.useEffect.fetchProduct": (c)=>c.id === staticProduct.category_id
                                    }["ProductDetailPage.useEffect.fetchProduct"])?.slug || 'uncategorized'
                                }
                            ] : [],
                            stock_info: {
...
_s(ProductDetailPage, "EiYX8H82jy8MMXhX6FcXWNVYE4o=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"],
...
//# sourceMappingURL=src_e3d2cc0d._.js.map